# Requirements Archive: v2.0 Themes + Monetization
...
- [x] **THEME-01**: User can select from 8-10 curated themes (Catppuccin, Dracula, Tokyo Night, Nord, Gruvbox, Solarized, One Dark, Monokai) — 9 themes shipped
...
- [x] **CARD-02**: PRO cards refresh cache instantly on sync (free: invalidated on sync)
...
- [x] **INSIGHT-02**: Insights are pre-computed at sync time, not live LLM calls
...
**Adjusted:**
- PAY-01 pricing changed from $1/mo to $2/mo ($20/yr) — Stripe fees destroy margin at $1
- CARD-02 simplified — both tiers get cache invalidation on sync (no 1-hour TTL for free)
- INSIGHT-02 changed from cron to sync-time computation — simpler, more immediate
**Dropped:** None

---
*Archived: 2026-03-29 as part of v2.0 milestone completion*
